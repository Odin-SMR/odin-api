...
class TestLevel1CachedViews:
    ...
    def test_backend_info(self, odinapi_service):
        ...
        # Only V4
        base_url = (
            '{host}/rest_api/{version}/freqmode_info/{date}/'
            '{backend}/')
    ...
    def test_freqmode_info_hierarchy(self, odinapi_service):
        ...
        base_url = '/'.join((
            odinapi_service, 'rest_api/{version}/freqmode_info/{date}/',
        ))
    ...
    def test_scan_log(self, odinapi_service):
        ...
        assert (
            ...
            == '{}/rest_api/v5/level1/2/7019446353/ptz/'.format(
                odinapi_service
            )
        )
    ...
    def test_scan_list(
            self, odinapi_service, start_time, end_time, apriori,
            expect_status, expect_count, expect_url_count,
    ):
