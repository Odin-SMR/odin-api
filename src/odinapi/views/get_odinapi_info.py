...
def get_vds_file_status():
    ...
    ace_file = os.path.join("/vds-data", "ACE_Level2", "v2", "2004-03", "ss2969.nc")
    ...
    smr_file = os.path.join("/odin-smr-2-1-data", "SM_AC2ab", "SCH_5018_C11DC6_021.L2P")
    osiris_file = os.path.join(
        "/osiris-data", "201410", "OSIRIS-Odin_L2-O3-Limb-MART_v5-07_2014m1027.he5"
    )
    vds_files = {
        "ace": ace_file,
        "mipas": mipas_file,
...
def get_ptz_file_status():
    ...
    solar_file = os.path.join("/var/lib/odindata/", "Solardata2.db")
    ptz_files = {
...
def get_apriori_file_status():
    ...
    ozone_file = os.path.join("/var/lib/odindata/apriori", "apriori_O3.mat")
    apriori_files = {
        "ozone": ozone_file,
    }
