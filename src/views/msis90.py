...
class Msis90(dict): 
	...
	def __init__ (self, solardatafile='/home/donal/Dropbox/solar/Solardata2.db'):
	...
	def extractPTZprofilevarsolar(self, datetime, lat,lng, altitudes):
		...
		cur=db.cursor()
		selectstr='select APAvg, ObsF10_7, ObsCtr81 from solardata where id ='+ str(datetime.year*10000+datetime.month*100+datetime.day)
		...
		for i,alt in enumerate(altitudes) :
			[d,t]=nrlmsis.gtd7(iydd,ut,alt,lat,lng,ut/3600-lng/15,f107a,f107,ap,mass)
			T[i]=t[1]
