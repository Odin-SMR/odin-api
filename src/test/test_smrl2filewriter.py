...
class TestL2Getter:
    ...
    @pytest.mark.parametrize("start,end,expect", (
        (
            ...
            [4473651439, 4473654697, 4475037239, 4476419781, 4477802323, 4517896043],
        ),
        (
            dt.datetime(2010, 1, 1),
            dt.datetime(2010, 2, 2),
            [4475033983, 4475037239, 4476419781, 4477802323, 4517896043],
        ),
        (
            dt.datetime(2010, 1, 1),
            dt.datetime(2010, 2, 1),
            [4475033983, 4475037239, 4476419781, 4477802323],
        ),
    ))
