...
def test_read_mipas_file(mipas_basepath_pattern, app_context):
    ...
    expect = {
        ...
        "eta": PartialListMatch(
            27,
            [11.432100296020508, 12.850199699401855],
            name="eta",
        ),
        ...
        "los": PartialListMatch(
            27,
            [12.368152618408203, 13.724454879760742],
            name="los",
        ),
        "pressure": PartialListMatch(
            60,
            [1002.919677734375, 626.6535034179688],
            name="pressure",
        ),
        ...
        "target": PartialListMatch(
            60,
            [0.12195233255624771, 0.13413915038108826],
            startidx=6,
            name="target",
        ),
        ...
        "temperature": PartialListMatch(
            60, [300.2716064453125, 278.47161865234375], name="temperature"
        ),
        ...
        "vr_akdiag": PartialListMatch(
            60,
            [120.0, 16.086973190307617],
            startidx=6,
            name="vr_akdiag",
        ),
        "vr_col": PartialListMatch(
            60,
            [0.0, 0.9611631035804749],
            startidx=5,
            name="vr_col",
        ),
        "vr_row": PartialListMatch(
            60,
            [1.2473870515823364, 1.2383352518081665],
            startidx=6,
            name="vr_row",
        ),
    }
