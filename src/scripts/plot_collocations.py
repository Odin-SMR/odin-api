...
def plot_data4xxx(freqmode, instrument, species):
    ...
    plt.plot(data3['dt'],data3['latitude'],'g.',label='osiris')
    plt.plot(data4['dt'],data4['latitude'],'c.',label='sageIII')
    plt.plot(data5['dt'],data5['latitude'],'y.',label='smiles')
    ax1.grid(True)
    ax1.minorticks_on()
    ax1.axes.xaxis.set_ticklabels([])
    ax1.yaxis.set_label_text('Lat. [Deg.]')
    plt.legend(bbox_to_anchor=(1.01, 0.95), loc=2, borderaxespad=0.,numpoints=1)
    ...
    plt.plot(data5['dt'],data5['longitude'],'y.')
    ax1.grid(True)
    ax1.minorticks_on()
    ...
    ax1 = plt.subplot2grid((2,5), (1,0), colspan=1,rowspan=1)
    plt.title('mls')
    ...
    ax1 = plt.subplot2grid((2,5), (1,2), colspan=1,rowspan=1)
    plt.title('osiris')
    ...
    ax1 = plt.subplot2grid((2,5), (1,3), colspan=1,rowspan=1)
    plt.title('sageIII')
    ...
    ax1 = plt.subplot2grid((2,5), (1,4), colspan=1,rowspan=1)
    plt.title('smiles')
